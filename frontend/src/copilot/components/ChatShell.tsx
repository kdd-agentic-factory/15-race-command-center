...
export default function ChatShell() {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden">
      {/* ─── Left Panel: session + model controls ─── */}
      <aside className="hidden md:flex md:w-64 flex-col border-r border-zinc-800 bg-zinc-900/50 shrink-0">
        <div className="px-4 py-4 border-b border-zinc-800">
          <div className="flex items-center gap-2.5">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-red-600 shadow-lg shadow-red-600/20">
              <svg
            ...
            <div>
              <p className="text-sm font-bold text-zinc-100 leading-tight">Race Copilot</p>
        ...
        <div className="px-4 py-3 border-t border-zinc-800">
          <button
            ...
            className="w-full text-xs text-zinc-500 hover:text-zinc-300
                       transition-colors py-1.5 rounded-lg hover:bg-zinc-800/50"
          >
            Clear conversation
          </button>
        </div>
